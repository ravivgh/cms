...
export const Assistant = () => {
  ...
  const handleSend = (e) => {
    ...
    if (requestMessage.trim()) {
      ...
      setTimeout(() => {
        ...
        if (requestMessage.toLowerCase() === "hi") {
  ...
  // useEffect(() => {
  //   // Simulate a delay (3 seconds) before showing the response
  //   const timer = setTimeout(() => {
  //     setIsLoading(false);
  //     setConversation([
  //       {
  //         request: "What is the student attendance?",
  //         response: "The student attendance is 85%.",
  //       },

  //       {
  //         request: "How do I track attendance?",
  //         response: "You can track attendance through the faculty portal.",
  //       },
  //     ]);
  //   }, 5000);
      ...
      {isAssistanceVisible ? (
        <div className="assistant-about  flex items-center justify-around mx-auto flex-wrap mt-10">
          <div className="faculty-intro-card">
            <Card className="w-[300px] h-[250px] shadow-[5px_0_10px_-11px_rgba(0,0,0,0.5)] rounded-3xl bg-[#74747425] hover:bg-[#74747431]">
          ...
          <div className="student-intro-card">
            <Card className="w-[300px] h-[250px] rounded-3xl bg-[#74747425] hover:bg-[#74747431]">
                ...
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                  <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                    ...
                    <div className="bg-gray-200 rounded-lg pt-2">
                      ...
                      <div className="relative w-full">
                        ...
                        <Button
                          className="absolute right-3 bottom-3 p-3 w-10 bg-gradient-to-r  from-[#0f141c] to-[#51729a] text-white rounded-full  transition-all duration-300 cursor-pointer "
                          aria-label="Send"
                          onClick={handleSend}
                        >
                          <VscSend className="text-xl text-gray-300 flex items-center justify-center" />
                        </Button>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                    <Select onValueChange={(value) => setSelectedRole(value)}>
                      <SelectTrigger className="w-[280px] text-[#cdcccc] bg-[#3a3e43]">
                        <SelectValue placeholder="Select a Role" />
                      </SelectTrigger>
                      <SelectContent className="bg-[#0f151c] border-0">
                        <SelectGroup>
                          ...
                          <SelectItem value="Student" className="bg-[#23272f]">
                            <div className="flex items-center ">
                              <PiStudentFill
                                style={{ fontSize: "25px" }}
                                className="text-black bg-[#a7d6aa] p-[3.5px] rounded-full"
                              />
                              <p className="pl-3 text-gray-300">Student</p>
                            </div>
                          </SelectItem>
                        </SelectGroup>
                      </SelectContent>
