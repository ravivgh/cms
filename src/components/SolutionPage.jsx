      ...
      <div className="">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-black ">
          ...
          <div className="mt-60 flex flex-col lg:flex-row items-center justify-center mx-auto space-y-8 lg:space-y-0 lg:space-x-8">
            ...
            <div>
              <img
                src="https://cdn.prod.website-files.com/608e9cc36cbcc089f0998643/6790a4ebf4fb9fb97a90c6f4_Rectangle%2034625984%20(1).png"
          ...
          <div className="my-36 ">
            <div className="flex items-center justify-around space-x-10">
              <img
                src={reportImg}
                alt=""
                className="w-[700px]  rounded-3xl shadow-xl"
              />
              <div className="text-black">
                <h1 className="text-4xl">Real-Time Report</h1>
                <p className="text-gray-500">
                  {" "}
                  Administrators can use the AI assistant to generate student
                  reports, such as identifying those who haven't paid fees or
            ...
            <div className="">
              <div className="text-center pt-20 pb-28 ">
                ...
                <p className="text-xl text-gray-500">
                  A unified interface , coding environment, and
                  trackpad-friendly whiteboarding ensures a smooth codeing for
                  every students.
                </p>
              </div>
