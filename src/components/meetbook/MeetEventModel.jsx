  ...
  return (
    <div className="h-screen w-full fixed left-0 top-0 flex justify-center items-center text-black z-40">
      <form className="bg-[#f0f4f9] rounded-3xl shadow-2xl w-1/4">
        <header className="bg-gray-100 px-4 py-2 flex justify-end items-center rounded-3xl">
        ...
        <footer className="flex justify-end border-t p-3 mt-5">
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 px-6 py-2 rounded-full text-white"
          >
            Save
          </button>
        </footer>
