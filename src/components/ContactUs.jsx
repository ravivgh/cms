  ...
  const videos = [
    {
      ...
      name: "Ravi Vaghela",
      background:
        "https://d2b1cooxpkirg1.cloudfront.net/publicAssets/homepage/solutions/bg-5.png",
    },
    {
      src: model1,
      avatar:
      ...
      name: "Neha Patel",
      background:
        "https://d2b1cooxpkirg1.cloudfront.net/publicAssets/homepage/solutions/bg-1.png",
    },
    {
      src: model1,
      avatar:
      ...
      name: "Neha Patel",
      background:
        "https://d2b1cooxpkirg1.cloudfront.net/publicAssets/homepage/solutions/bg-4.png",
    },
    {
      src: model1,
      avatar:
      ...
      name: "Neha Patel",
      background:
        "https://d2b1cooxpkirg1.cloudfront.net/publicAssets/homepage/solutions/bg-3.png",
    },
  ];
  ...
  return (
    <>
          ...
          <div className="mt-60 flex flex-col lg:flex-row items-center justify-center mx-auto space-y-8 lg:space-y-0 lg:space-x-8">
                ...
                <div className="">
                  ...
                  <div className="space-y-5 max-w-lg">
                    ...
                    <div className="space-y-3 max-w-lg">
                      <h1 className="text-blue-800 flex items-center gap-2 text-xl">
                        {" "}
                        <IoLocationOutline className="text-blue-800" />
                        CampusFlow HQ
                      </h1>
                    ...
                    <div className="space-y-3 max-w-lg">
                      ...
                      <div className="bg-gray-100 w-fit px-5 py-3 rounded-md text-lg">
                        <h1>Support</h1>
                        <span className="text-gray-500">
                          support@campusflow
                        </span>
            ...
            <div>
              <img
                ...
                className="w-[700px] mx-auto lg:mx-0"
              />
            </div>
          </div>
        </div>
      ...
      <div className="mt-16 space-y-20">
        <div className="">
          <div className="">
            <h1 className="bg-blue-800 text-center w-fit px-3 py-2  rounded-full mx-auto text-white">
              Best in class process
            </h1>
            <h1 className="text-gray-800 text-4xl text-center mt-8 max-w-2xl mx-auto font-extralight">
              Get an{" "}
              <span className="font-medium text-black">
                all-in-one solution
              </span>{" "}
              for all <span className="font-medium text-black">manage</span>{" "}
              problems
            </h1>
          </div>
        </div>
