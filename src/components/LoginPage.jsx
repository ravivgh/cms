...
import { MdKeyboardArrowDown, MdOutlineContactSupport } from "react-icons/md";
  ...
  return (
    <>
      <div className="container px-4">
        ...
        <div className="intro-login mt-40">
          <h1 className="text-center text-xl font-medium ">
            Login into your account
          </h1>
        </div>
        <div className="login-showcase flex flex-wrap items-center justify-center pt-12 gap-8">
          {/* Faulty Card */}
          <div className="faulty-login-card flex justify-center">
            <Card className="w-[400px] h-[400px] shadow-[5px_0_10px_-11px_rgba(0,0,0,0.5)]">
              <div className="faulty-icon-intro flex items-center justify-center pt-10 pb-3">
                <div className="faulty-band flex items-center justify-around bg-[#f1ce8b] p-2 w-fit rounded-full gap-2">
              ...
              <CardHeader>
                <CardTitle className="text-center">
                  <span className="font-light px-2">For</span>Faculty
                </CardTitle>
          ...
          <div className="student-login-card flex justify-center">
            <Card className="w-[400px] h-[400px]">
              <div className="student-icon-intro flex items-center justify-center pt-10 pb-3">
                <div className="student-band flex items-center justify-around bg-[#a7d6aa] p-2 w-fit rounded-full gap-2">
              ...
              <CardHeader>
                <CardTitle className="text-center">
                  <span className="font-light px-2">For</span>Student
                </CardTitle>
                <CardDescription className="text-center pt-5 text-base">
                  Join the student portal for a seamless academic experience
                </CardDescription>
          ...
          <div className="admin-login-card flex justify-center">
            <Card className="w-[400px] h-[400px] shadow-[-5px_0_10px_-11px_rgba(0,0,0,0.5)]">
              <div className="admin-icon-intro flex items-center justify-center pt-10 pb-3">
                <div className="admin-band flex items-center justify-around bg-[#acc7e7] p-2 w-fit rounded-full gap-2">
              ...
              <CardHeader>
                <CardTitle className="text-center">
                  <span className="font-light px-2">For</span>Admin
                </CardTitle>
                <CardDescription className="text-center pt-5 text-base">
                  Login to manage college operations, and student information
                </CardDescription>
      ...
      <div className=" py-20  grid md:grid-cols-3 gap-[15px] md:gap-[33px] items-end mx-auto max-w-[1200px]">
