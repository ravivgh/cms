...
import adminDetails from "../assets/admin.jpg";
import image1 from "../assets/allView.png";
import ProgressUser from "./ProgressUser";
import excelImage from "../assets/sExcel.jpg";
import excelImage2 from "../assets/fExcel.jpg";
  ...
  return (
    <>
                        ...
                        <div className="space-y-5">
                          ...
                          <div className="">
                            ...
                            <p className="text-gray-800 text-sm">
                              manage college operations, and student information
                            </p>
                          </div>
                        </div>
                      </CardContent>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start space-y-5 md:space-y-0 md:space-x-10 max-w-full mx-20">
                  ...
                  <div className="space-y-2 max-w-lg">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      recruitment, student data, and administrative tasks—all in
                      one platform.
                    </p>
                    <div className="w-full h-[0.8px] bg-gray-500"></div>
                    <div className="text-sm">
                      <h1 className="py-2 text-lg font-semibold">Our Values</h1>
                      <div className="space-y-2">
                        ...
                        <div className="bg-gray-100 w-fit px-5 py-5 rounded-md space-y-2">
                          ...
                          <p className="text-gray-600">
                            ...
                            educational technology, ensuring our platform stays
                            at the forefront of digital transformation in
                            education.
                          </p>
                        </div>
                        <div className="bg-gray-100 w-fit px-5 py-5 rounded-md space-y-2">
                          ...
                          <p className="text-gray-600">
                            ...
                            users – whether you're a student, faculty member, or
                            administrator.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="text-sm space-y-2">
                    ...
                    <div className="bg-gray-100 w-fit px-5 py-5 rounded-md space-y-2">
                      ...
                      <p className="text-gray-600">
                        ...
                        with educators, administrators, and students to make our
                        platform more effective and impactful.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="flex flex-wrap min-h-screen">
        <div className="left-side-brief w-full md:w-1/2 p-10 flex items-center justify-center flex-col">
          <div className="heading-intro relative top-16">
                    ...
                    {step === 3 && (
                      <div className="text-black">
                        ...
                        {selectedOption === "student" && (
                          <>
                            <h1 className="text-xl pb-5 font-medium text-[#1d68bd]">
                      ...
                      <div>
                        <div className="">
                          <h1 className="text-xl pb-5 font-medium text-black flex items-center gap-2">
                            Import Your{" "}
                            <span className="text-[#5e5e5e] flex items-center gap-1 bg-slate-200 rounded-full px-2 text-sm py-1">
                              {" "}
                          ...
                          <div className="bg-white  rounded-3xl w-[400px] border border-gray-300">
                            <div className="px-5  py-5">
                              <div className="bg-[#f2f7ff] py-14 px-10 rounded-sm border-2 border-dashed border-blue-500 flex items-center flex-col justify-center">
                                ...
                                <label
                                  htmlFor="excelFile"
                                  className="custom-file-upload bg-[#67676747] py-1 px-2 rounded-sm text-[#3d3d3d] flex items-center justify-center gap-1"
                                >
                                  <MdOutlineFileUpload />
                                  Select File
                                </label>
                            ...
                            {fileName && (
                              <div className="file-info bg-[#2168b7] rounded-b-3xl py-3 flex items-center justify-around">
                                <div className="">
                                  <RiFileExcel2Fill
                    ...
                    {step === 5 && (
                      <div>
                        <div className="">
                          ...
                          <div className="bg-white  rounded-3xl w-[400px]">
                            <div className="px-5  py-5">
                              <div className="bg-[#f2f7ff] py-14 px-10 rounded-sm border-2 border-dashed border-blue-500 flex items-center flex-col justify-center">
                                <Input
                                  id="excelFile"
                            ...
                            {fileName && (
                              <div className="file-info bg-[#b72171] rounded-b-3xl py-3 flex items-center justify-around">
                                <div className="">
                                  <RiFileExcel2Fill
                                    style={{ fontSize: "30px", color: "white" }}
                                  />
                    ...
                    {isDialogOpen && (
                      <div className="blank">
                        <div className="show-popup">
                          ...
                          <div className="heading text-white  text-xl text-center">
                            <h1> {dialogMessage}</h1>
                            <p className="text-sm">
        ...
        <div className="right-side-content w-full md:w-1/2 flex flex-col items-center justify-center bg-[#3f3f3f]">
          <div className="">
            <div className=" w-full max-w-[600px] mt-36 shadow-2xl ">
              <div className="bg-[#040404] rounded-t-3xl px-4  py-4">
                <h1 className=" text-base px-4  py-2 flex items-center gap-2 bg-[#116752] text-white w-fit rounded-full">
                  <div className="w-2 h-2 rounded-full bg-[#ffcd6c]"></div>
                  ...
                  {step === 1 && (
                    <div className="text-gray-500 py-5 px-5">
                      <h1 className="text-[#3c3c3c] text-base">
                        Please enter the{" "}
                        <span className="font-bold">name and address</span> of
                        <span className="font-bold"> your college</span> to
                        establish your institutions identity within the
                        management system. This step is essential for accurate
                  ...
                  {step === 4 && (
                    <div className="text-gray-500 py-5 px-5">
                      <h1 className="text-[#3c3c3c] text-md">
                        The Admin{" "}
                        <span className="font-bold">
                          Import Student Excel Data
                        </span>{" "}
                        feature streamlines the process of adding and updating
                        student records in the system. It allows administrators
                        to efficiently manage large datasets without manual
                        entry, ensuring faster data management and reduced
                        errors.
                      </h1>
                    </div>
                  )}
          ...
          <div className="flex items-center  flex-col py-5">
            {/* <div className="">
              <h1 className="text-white text-2xl pt-24 font-bold">
                You need information
              </h1>
            </div> */}
            ...
            {/* {step === 1 && (
                <>
                  <motion.video
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, x: -100 }}
                    className=" h-auto w-[600px] rounded-3xl"
                    autoPlay
                    loop
                    muted
                  />
      ...
      <div className="my-20 mx-5 md:mx-10">
        <div className="my-16 mx-auto flex flex-col items-center justify-center text-center max-w-[900px] space-y-7">
          <h1 className="text-white text-xl md:text-xl text-center bg-[#1d68bd] px-5 rounded-full py-2">
            How you Register?
          </h1>
          <div className="space-y-7">
            <h1 className="text-gray-800 text-4xl font-extralight">
              Simplify
              <span className="text-black font-normal"> Campus Operations</span>
            </h1>
            <p className="text-gray-500 text-xl">
              Whether you're a small institute looking to{" "}
              <span className="text-black">streamline operations</span> or a
              large university <span className="text-black">managing</span>{" "}
              diverse campuses,{" "}
              <span className="text-black">
                our College Management System adapts to your unique needs.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="text-black border-l border-t border-b border-black rounded-l-[50px] p-5 w-full md:w-5/6">
            {/* Step 1 */}
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between space-y-5 md:space-y-0 ">
              <div className="relative right-0 md:right-12 bg-black w-fit p-4 rounded-full top-10">
                <FaUniversity className="text-white w-6 h-6" />
              </div>
              <div className="md:w-1/2 pt-10">
                <h1 className="text-2xl md:text-3xl">College Information</h1>
                <p className="text-lg md:text-lg py-5 text-gray-500">
                  The <span className="text-black">admin provides</span>{" "}
                  essential{" "}
                  <span className="text-black">details about the college.</span>{" "}
                  This includes:{" "}
                  <span className="text-black">
                    The official name of the college. The complete address of
                    the college, including city, state, and postal code.{" "}
                  </span>{" "}
                  This information ensures accurate records and identification
                  of the college in the system.
                </p>
              </div>
              <motion.video
                src={step1}
            ...
            {/* Step 2 */}
            <div className="my-10 flex flex-col md:flex-row items-center md:items-start justify-between space-y-5 md:space-y-0">
              <div className="relative right-0 md:right-12 bg-black w-fit p-4 rounded-full">
                <BiSolidUserDetail className="text-white w-6 h-6" />
              </div>

              <div className="md:w-1/2">
                <h1 className="text-2xl md:text-3xl">Admin Personal Details</h1>
                <p className="text-lg md:text-lg py-5 text-gray-500">
                  The admin <span className="text-black">enters </span> their
                  <span className="text-black"> personal information</span> to
                  <span className="text-black"> register</span> as the primary
                  administrator for the college.{" "}
                  <span className="text-black">
                    {" "}
                    Required fields according.
                  </span>
                </p>
              </div>
              <img
                src="http://localhost:3000/src/assets/admin.jpg"
            ...
            <div className="my-10 flex flex-col md:flex-row items-center md:items-start justify-between space-y-5 md:space-y-0">
              <div className="relative right-0 md:right-12 bg-black w-fit p-4 rounded-full">
                <PiMicrosoftExcelLogoFill className="text-white w-6 h-6" />
              </div>
              <div className="md:w-1/2">
                <h1 className="text-2xl md:text-3xl">Excel Import</h1>
                <p className="text-lg md:text-lg py-5 text-gray-500">
                  The admin{" "}
                  <span className="text-black">uploads Excel files</span>{" "}
                  containing{" "}
                  <span className="text-black">faculty and student</span>{" "}
                  information to streamline the onboarding process.
                </p>
              </div>
              <img
                src="http://localhost:3000/src/assets/sExcel.jpg"
                alt="Excel Import"
                className="w-full md:w-[500px]"
              />
            </div>
