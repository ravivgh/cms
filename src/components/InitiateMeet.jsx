...
const InitiateMeet = () => {
  ...
  // Existing student data (unchanged but included for reference)
  const students = [
    {
      id: 1,
      name: "John Doe",
  ...
  // Rest of your existing states and functions (video, audio, etc.) remain unchanged
            ...
            <div className="bg-[#27282c] rounded-xl p-6 mb-6">
              <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-semibold text-white">
                  {showHistory ? "Meeting History" : "Join Meeting"}
                </h1>
                <button
                ...
                >
                  ...
                  {showHistory ? "Back to Join" : "View History"}
                </button>
              </div>
                ...
                <>
                  ...
                  <div className="mb-8">
                    ...
                    {selectedClass && selectedSection && (
                      <div className="mb-6 p-4 bg-[#1d1e20] rounded-lg">
                        <p className="text-white">
                          Showing students for: {selectedClass} Section{" "}
                          {selectedSection}
                        </p>
                      </div>
                    )}
