...
export default function CreateEventButton() {
  ...
  const handleClose = (option) => {
    ...
    if (option === "Subject Schedule") {
      ...
      navigate("/collegemaster-faculty/settings/academic"); // Redirect to the Holiday page
    } else if (option === "Appointment") {
      navigate("/collegemaster-faculty/settings/appointment"); // Redirect to the Holiday page
    }
  };
  return (
    <>
